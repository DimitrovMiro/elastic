...
UNICAST_HOSTS='["'"$NAMESPACE_PREFIX"'master-1-vm'"$UNICAST_HOST_PORT"'","'"$NAMESPACE_PREFIX"'master-2-vm'"$UNICAST_HOST_PORT"'","'"$NAMESPACE_PREFIX"'master-3-vm'"$UNICAST_HOST_PORT"'"]'
